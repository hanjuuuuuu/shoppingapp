...
var tyear = String(date.getFullYear());
...
const App = () => {
   ...
   const onClick = () => {     //조회하기 버튼 클릭하면 서버 정보 생성하기
      ...
      let fieldfYear =  fieldData.dateFromYear || fyear
      let fieldtYear = fieldData.dateToYear || tyear
   ...
   return (
      ...
      <Form.Item name = "dateFromYear">
         <Select defaultValue={fyear} style={{ marginTop: 30, width: 100 }} onChange={selfChange}>
      ...
      <Form.Item name = "dateToYear">
         <Select defaultValue={tyear} style={{ marginTop: 30, marginLeft:10, width: 100 }} onChange={selfChange}>
            <Option value="2017">2017</Option>
            <Option value="2018">2018</Option>
            <Option value="2019">2019</Option>
            <Option value="2020">2020</Option>
